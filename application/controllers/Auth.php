...
class Auth extends CI_Controller
{
    ...
    private function _login()
    {
        ...
        if ($user) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">
            Email is not registered!, please registration soon!</div>');
            redirect('auth');
        }
    }
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data['title'] = 'WPK User Registration';
            $this->load->view('templates/auth_header', $data);
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'teknisikomputer1010@gmail.com',
            'smtp_pass' => 'bangbangtut1010',
            'smtp_port' => 465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n"
        ...
        $this->email->from('teknisikomputer1010@gmail.com', 'Tim Teknisi Gedung 1');
